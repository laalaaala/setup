...
# 6. Autostart-Konfiguration für Openbox
...
# 7. Chromium-Startskript erstellen
...
# 8. Openbox beim Start laden
cat <<EOF | tee "$USER_HOME/.xinitrc"
exec openbox-session
EOF
sync

# 9. Automatischen GUI-Start sicherstellen
...
# 11. Statische IP-Adresse für wlan0 setzen
...
# 13. Hotspot-Dienste aktivieren
sudo systemctl unmask hostapd
sudo systemctl enable hostapd dnsmasq
sudo systemctl restart hostapd dnsmasq

# 14. Standby und Bildschirmschoner deaktivieren
...
# 15. WLAN-Sperre beim Boot entfernen
...
# 16. Hostapd-Dienstverzögerung für stabilen Start
